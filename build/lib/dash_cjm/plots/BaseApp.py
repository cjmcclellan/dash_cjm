...
class BaseApp(object):
    ...
    def __init__(self, name, django=False, hidden_update=True, graph_height=None, graph_width=None):
    ...
    def init_plot(self, *args, **kwargs):
        ...
        self.plot = self.plot_class(*args, **kwargs)
...
if __name__ == '__main__':
    test = BaseApp('X', 'Y', 'Testing', y_scale='log')
